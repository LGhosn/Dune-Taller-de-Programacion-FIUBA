...
struct CmdEnemigoDespliegaUnidadDTO {
    ...
    CmdEnemigoDespliegaUnidadDTO(uint8_t id_unidad, uint8_t id_jugador, uint8_t tipo_unidad,
                                uint16_t tiempo_entrenamiento, uint16_t x, uint16_t y, uint16_t vida) :
                            id_unidad(id_unidad),
