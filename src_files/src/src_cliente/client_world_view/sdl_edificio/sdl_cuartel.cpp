...
CuartelSDL::CuartelSDL(uint8_t id, uint8_t id_jugador,uint16_t vida, SDL2pp::Renderer& renderer,
                    ...
                    EdificioSDL(id, id_jugador, vida, renderer, texturas.obtenerEdificio(1, casa, false),
...
bool CuartelSDL::cambiarHP(uint16_t hp_edificio) {
...
void CuartelSDL::update(uint32_t origen_movil_x, uint32_t origen_movil_y, long frame_transcurridos, float zoom) {
    this->zoom = zoom;
