...
std::shared_ptr<EdificioSDL> EdificioFactorySDL::crearEdificio(uint8_t id_edificio, uint8_t id_jugador, uint8_t casa,
    ...
    switch (tipo_edificio) {
        case 0: {
            return std::shared_ptr<EdificioSDL>( new CentroSDL(id_edificio, id_jugador, renderer, texturas,
                                coords, 3, 3, casa, constantes,
                                colores.obtenerColor(id_jugador)));
        }
        case 1: {
            return std::shared_ptr<EdificioSDL>(new CuartelSDL(id_edificio, id_jugador, renderer, texturas,
                                 coords, 3, 2, casa, constantes,
                                 colores.obtenerColor(id_jugador)));
        }
        case 2: {
            return std::shared_ptr<EdificioSDL>(new FabricaLigeraSDL(id_edificio, id_jugador, renderer, texturas,
                                        coords, 3, 3, casa, constantes,
                                        colores.obtenerColor(id_jugador)));
        }
        case 3: {
            return std::shared_ptr<EdificioSDL>(new FabricaPesadaSDL(id_edificio, id_jugador, renderer, texturas,
                                        coords, 4, 4, casa, constantes,
                                        colores.obtenerColor(id_jugador)));
        }
        case 4: {
            return std::shared_ptr<EdificioSDL>(new PalacioSDL(id_edificio, id_jugador, renderer, texturas,
                                        coords, 3, 3, casa, constantes,
                                        colores.obtenerColor(id_jugador)));
        }
        case 5: {
            return std::shared_ptr<EdificioSDL>(new RefineriaSDL(id_edificio, id_jugador, renderer, texturas,
                                coords, 3, 3, casa, constantes,
                                colores.obtenerColor(id_jugador)));
        }
        case 6: {
            return std::shared_ptr<EdificioSDL>(new SiloSDL(id_edificio, id_jugador, renderer, texturas,
                                coords, 1, 1, casa, constantes,
                                colores.obtenerColor(id_jugador)));
        }
        case 7: {
            return std::shared_ptr<EdificioSDL>(new TrampaSDL(id_edificio, id_jugador, renderer, texturas,
                                coords, 3, 3, casa, constantes,
                                colores.obtenerColor(id_jugador)));
        }
        default:
