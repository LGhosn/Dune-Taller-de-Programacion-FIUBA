...
SiloSDL::SiloSDL(uint8_t id, uint8_t id_jugador, SDL2pp::Renderer& renderer,
            ...
            EdificioSDL(id, id_jugador, renderer, texturas.obtenerFramesSilo(casa)[0],
...
void SiloSDL::cambiarHP(uint16_t hp_edificio) {
